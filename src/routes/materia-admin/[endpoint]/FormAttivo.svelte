...
<form action="/api/materia/" id="form-attivo" method="post">
    <input type="hidden" name="id" value={ materia.id }>
    <label class="swap">
      {#if materia.attivo}
          <input type="checkbox" name="attivo" id="attivo" checked on:click={() => document.getElementById("form-attivo").submit()}/>
      {:else}
          <input type="checkbox" name="attivo" id="attivo"/>
      {/if}
