<script>
    ...
    export function sendMateria() {
        const form = document.getElementById('form-attivo');
...
<form id="form-attivo">
    ...
    <label class="swap">
        {#if materia.attivo}
            <input type="checkbox" name="attivo" id="attivo" checked on:change={sendMateria}/>
        {:else}
            <input type="checkbox" name="attivo" id="attivo" on:change={sendMateria}/>
        {/if}
